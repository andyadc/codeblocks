...
public class SettleTaskExecutor extends ThreadPoolExecutor {

	private final static Logger logger = LoggerFactory.getLogger(SettleTaskExecutor.class);

	private final AtomicLong taskUndone = new AtomicLong(0); //未完成的任务计数

	public SettleTaskExecutor(int corePoolSize, int maximumPoolSize, int queueCapacity) {
