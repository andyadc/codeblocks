...
//        singleThreadProducer();
	...
	private static StockQuotationInfo createQuotationInfo() {
		...
		int stockCode = 600100 + tlr.nextInt(10);
		// 随机产生一个0到1之间的浮点数
		...
		quotationInfo.setCurrentPrice(Float.parseFloat(decimalFormat.format(11 + random)));// 设置最新价在11元浮动
		...
		//以及当前价是否已是最高价
		quotationInfo.setStockCode(Integer.toString(stockCode));
