...
//		calculate(1000000, 10, 0.035d, 1);
		...
		System.out.println(calcCompoundRate(1000000d, 0.05d, 10, 365d));
		System.out.println(calcCompoundRate(1000000d, 0.05d, 10, 10d));
		System.out.println(calcCompoundRate(1000000d, 0.05d, 10, 4d));
		System.out.println(calcCompoundRate(1000000d, 0.05d, 10, 2d));
