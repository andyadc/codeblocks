package com.andyadc.codeblocks.kit.crypto.bcrypt;

import com.andyadc.codeblocks.kit.bytes.Bytes;
import com.andyadc.codeblocks.kit.bytes.BytesTransformer;
import com.andyadc.codeblocks.kit.bytes.BytesValidators;
import com.andyadc.codeblocks.kit.bytes.MutableBytes;
...
public final class BCrypt {
	 ...
	 */
	public static final byte MAJOR_VERSION = 0x32;
	 ...
	 */
	public static final byte SEPARATOR = 0x24;
	...
	public static final class Result {
		...
		public Result(HashData details, boolean verified) {
