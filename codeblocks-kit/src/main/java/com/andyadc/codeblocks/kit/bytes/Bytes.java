...
public class Bytes implements Comparable<Bytes>, Serializable, Iterable<Byte> {
	 ...
	 * memory, so be careful what to read in. This uses {@link RandomAccessFile} under the hood.
	 *
	 * @param file   to read from
	 ...
	 *
	 * @param utf8String to get the internal byte array from
	 * @param form       to normalize, usually you want {@link Normalizer.Form#NFKD} for compatibility
	 * @return new instance
	 */
	 ...
	 * use {@link ByteBuffer} or {@link ByteArrayOutputStream} for that.
	 *
