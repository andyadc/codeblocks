...
public abstract class FileSystemUtils {
    ...
    public static void copyRecursively(File src, File dest) throws IOException {
        Validate.isTrue(src != null && (src.isDirectory() || src.isFile()), "Source File must denote a directory or file");
        Validate.notNull(dest, "Destination File must not be null");
