package com.andyadc.codeblocks.test.crypto.bcrypt;

import com.andyadc.codeblocks.kit.bytes.Bytes;
import com.andyadc.codeblocks.kit.bytes.BytesTransformer;
import com.andyadc.codeblocks.kit.crypto.bcrypt.BCrypt;
import com.andyadc.codeblocks.kit.crypto.bcrypt.BCryptParser;
import com.andyadc.codeblocks.kit.crypto.bcrypt.IllegalBCryptFormatException;
import com.andyadc.codeblocks.kit.crypto.bcrypt.LongPasswordStrategies;
import com.andyadc.codeblocks.kit.crypto.bcrypt.LongPasswordStrategy;
import com.andyadc.codeblocks.kit.crypto.bcrypt.Radix64Encoder;
import com.andyadc.codeblocks.test.crypto.bcrypt.misc.BcryptTestEntry;
import com.andyadc.codeblocks.test.crypto.bcrypt.misc.Repeat;
import com.andyadc.codeblocks.test.crypto.bcrypt.misc.RepeatRule;
...
import static com.andyadc.codeblocks.kit.crypto.bcrypt.BCrypt.MAJOR_VERSION;
