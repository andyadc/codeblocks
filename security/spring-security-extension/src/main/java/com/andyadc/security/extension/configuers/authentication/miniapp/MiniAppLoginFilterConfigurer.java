...
import com.andyadc.security.extension.configuers.authentication.AbstractLoginFilterConfigurer;
import com.andyadc.security.extension.handler.LoginAuthenticationSuccessHandler;
...
public class MiniAppLoginFilterConfigurer<H extends HttpSecurityBuilder<H>> extends AbstractLoginFilterConfigurer<H, MiniAppLoginFilterConfigurer<H>, MiniAppAuthenticationFilter> {
	...
	protected AuthenticationProvider authenticationProvider(H http) {
		...
		MiniAppUserDetailsService miniAppUserDetailsService
			= this.miniAppUserDetailsService != null ? this.miniAppUserDetailsService : getBeanOrNull(applicationContext, MiniAppUserDetailsService.class);
