...
public @interface Profiled {
    ...
    /**
     * The tag that should be set on the {@link com.andyadc.perf4j.StopWatch} when the execution time is logged. If not
     ...
     * use to log the {@link com.andyadc.perf4j.StopWatch}.
     *
