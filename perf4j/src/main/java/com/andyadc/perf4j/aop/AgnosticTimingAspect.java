...
import com.andyadc.perf4j.helpers.Perf4jProperties;
 ...
 * your desired framework. For example, if you look at the {@link com.andyadc.perf4j.aop.AbstractTimingAspect}, you can see
 * that it delegates all functionality to this class - it just includes the necessary AspectJ annotations and wraps
 * the AspectJ-specific ProceedingJoinPoint as an {@link com.andyadc.perf4j.aop.AbstractJoinPoint}.
 *
...
public class AgnosticTimingAspect {
     ...
     */
    private Map<String, Expression> jexlExpressionCache = new ConcurrentHashMap<>(64, .75F, 16);
