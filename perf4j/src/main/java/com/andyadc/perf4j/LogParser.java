...
import com.andyadc.perf4j.chart.GoogleChartGenerator;
import com.andyadc.perf4j.chart.StatisticsChartGenerator;
import com.andyadc.perf4j.helpers.GroupedTimingStatisticsCsvFormatter;
import com.andyadc.perf4j.helpers.GroupedTimingStatisticsFormatter;
import com.andyadc.perf4j.helpers.GroupedTimingStatisticsTextFormatter;
import com.andyadc.perf4j.helpers.GroupingStatisticsIterator;
import com.andyadc.perf4j.helpers.StatsValueRetriever;
import com.andyadc.perf4j.helpers.StopWatchLogIterator;
...
public class LogParser {
     ...
     *
     * @param inputLog               The log being parsed, which should contain {@link com.andyadc.perf4j.StopWatch} log messages.
    ...
    protected static void closeGraphingOutput(PrintStream graphingOutput) {
        if (graphingOutput != null) {
