...
(
    `key`                 BIGINT(20) UNSIGNED NOT NULL COMMENT '主键',
    `id`                  BIGINT(20) UNSIGNED NOT NULL COMMENT '账户表主键',
    ...
    `contract_account`    VARCHAR(20)                  DEFAULT NULL COMMENT '签约账号，如银行卡号，第三方平台的账户号',
    `mobile_number`       VARCHAR(20)                  DEFAULT NULL COMMENT '银行预留手机号',
    `pin`                 VARCHAR(20)                  DEFAULT NULL COMMENT '预留的身份证号',
    `real_name`           VARCHAR(64)                  DEFAULT NULL COMMENT '真实姓名',
    `expiration_date`     VARCHAR(20)                  DEFAULT NULL COMMENT '过期时间',
    `security_code`       VARCHAR(20)                  DEFAULT NULL COMMENT '安全码',
    `contract_token`      VARCHAR(256)                 DEFAULT NULL COMMENT 'token内容或签约号',
