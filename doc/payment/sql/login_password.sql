...
CREATE TABLE `login_password` (
  ...
  COMMENT '密码类型',
  `password_status`   TINYINT(4)          DEFAULT NULL
  COMMENT '密码状态',
  `enc_password`      CHAR(32)            DEFAULT NULL
  COMMENT '密码密文',
  `init_password`     TINYINT(4)          DEFAULT NULL
  COMMENT '初始密码标志',
  `is_forced_change`  TINYINT(4)          DEFAULT NULL
  COMMENT '是否强制修改密码',
  ...
  COMMENT '最后修改时间',
  `version`           INT(12)    NOT NULL DEFAULT '1'
  COMMENT '版本号',
