...
public class AnnotationConfigApplicationContextTest {
	...
	public void testConverter() {
		...
		assertEquals(LocalDate.parse("2025-01-06"), bean.injectedLocalDate);
		assertEquals(LocalTime.parse("10:45:01"), bean.injectedLocalTime);
		assertEquals(LocalDateTime.parse("2025-01-06T10:45:01"), bean.injectedLocalDateTime);
		assertEquals(ZonedDateTime.parse("2025-01-06T10:45:01+08:00[Asia/Shanghai]"), bean.injectedZonedDateTime);
	...
	PropertyResolver createPropertyResolver() {
		...
		ps.put("convert.localdate", "2025-01-06");
		ps.put("convert.localtime", "10:45:01");
		ps.put("convert.localdatetime", "2025-01-06T10:45:01");
		ps.put("convert.zoneddatetime", "2025-01-06T10:45:01+08:00[Asia/Shanghai]");
