...
/**
 * A JsonLayout builds its {@link #toJsonMap(ILoggingEvent) jsonMap} from a
 * source {@link ILoggingEvent ILoggingEvent} with the following keys/value pairs:
 * <p/>
 * <pre>
 * <table>
 *     <tr>
 ...
 *         <td nowrap="nowrap">String value of <code>ILoggingEvent.{@link ILoggingEvent#getTimeStamp() getTimeStamp()}</code></td>
 ...
 *         <td nowrap="nowrap">String value of <code>ILoggingEvent.{@link ILoggingEvent#getLevel() getLevel()}</code></td>
 *         <td><code>String.valueOf(event.getLevel());</code></td>
 *         <td>true</td>
 *     </tr>
 *     <tr>
 *         <td nowrap="nowrap">{@code thread}</td>
 *         <td nowrap="nowrap"><code>ILoggingEvent.{@link ILoggingEvent#getThreadName() getThreadName()}</code></td>
 *         <td></td>
 *         <td>true</td>
 *     </tr>
 *     <tr>
 *         <td nowrap="nowrap">{@code mdc}</td>
 *         <td nowrap="nowrap"><code>ILoggingEvent.{@link ILoggingEvent#getMDCPropertyMap() getMDCPropertyMap()}</code></td>
 ...
 *     <tr>
 *         <td nowrap="nowrap">{@code thread}</td>
 *         <td nowrap="nowrap"><code>ILoggingEvent.{@link ILoggingEvent#getLoggerName() getLoggerName()}</code></td>
 *         <td></td>
 *         <td>true</td>
 *     </tr>
 *     <tr>
 *         <td nowrap="nowrap">{@code message}</td>
 *         <td nowrap="nowrap"><code>ILoggingEvent.{@link ILoggingEvent#getFormattedMessage() getFormattedMessage()}</code></td>
 ...
 *         <td nowrap="nowrap"><code>ILoggingEvent.{@link ILoggingEvent#getMessage() getMessage()}</code></td>
 *         <td></td>
 *         <td>false</td>
 *     </tr>
 *     <tr>
 *         <td nowrap="nowrap">{@code exception}</td>
 *         <td nowrap="nowrap"><code>ILoggingEvent.{@link ILoggingEvent#getThrowableProxy() getThrowableProxy()}</code></td>
 *         <td>If there is no exception, this property will not be added to the JSON map.  If there is an exception, it
 *             will be formatted to a String first via a {@link ThrowableProxyConverter ThrowableProxyConverter}.</td>
 *         <td>true</td>
 *     </tr>
 *     <tr>
 *         <td nowrap="nowrap">{@code context}</td>
 *         <td nowrap="nowrap"><code>ILoggingEvent.{@link ILoggingEvent#getLoggerContextVO() getLoggerContextVO()}</code></td>
