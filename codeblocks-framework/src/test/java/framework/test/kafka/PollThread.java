...
public class PollThread implements Runnable {
	...
	private final ReentrantLock offSetsLock = new ReentrantLock();
	private final ReentrantLock needPauseLock = new ReentrantLock();
	private final ReentrantLock needResumeLock = new ReentrantLock();

	private final Map<TopicPartition, OffsetAndMetadata> offsets = new HashMap<>();
	private final Set<TopicPartition> needPauseSet = new HashSet<>();
	private final Set<TopicPartition> needResumeSet = new HashSet<>();
