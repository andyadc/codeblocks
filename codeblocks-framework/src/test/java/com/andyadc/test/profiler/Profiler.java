package com.andyadc.test.profiler;
...
public final class Profiler {
	...
	public static final class Entry {
		...
		private Entry(Object message/*描述信息*/, Entry parentEntry/*父节点信息*/, Entry firstEntry/*第一个节点*/) {
			...
			this.startTime = ProfilerSwitch.getInstance().isOpenProfilerNanoTime() ?
				System.nanoTime() :
		...
		private void release() {
			endTime = ProfilerSwitch.getInstance().isOpenProfilerNanoTime() ?
				System.nanoTime() :
				System.currentTimeMillis();
		}
